                      ...
                      xfs_quota_t* quota)
{
	...
	fs_disk_quota_t disk_quota = {
		...
		.d_blk_hardlimit = quota->block_hard_limit / BASIC_BLOCK_SIZE,
		.d_blk_softlimit = quota->block_soft_limit / BASIC_BLOCK_SIZE,
		.d_ino_hardlimit = quota->inode_hard_limit,
		.d_ino_softlimit = quota->inode_soft_limit,
		.d_fieldmask =
                      ...
                      xfs_quota_t* quota)
{
	...
	quota->block_hard_limit	= disk_quota.d_blk_hardlimit * BASIC_BLOCK_SIZE;
	quota->block_soft_limit	= disk_quota.d_blk_softlimit * BASIC_BLOCK_SIZE;
	quota->inode_hard_limit	= disk_quota.d_ino_hardlimit;
	quota->inode_soft_limit	= disk_quota.d_ino_softlimit;
	quota->blocks_used   	= disk_quota.d_bcount * BASIC_BLOCK_SIZE;
	quota->inodes_used 		= disk_quota.d_icount;
